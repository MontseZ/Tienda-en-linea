...
<div class="form-group">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
        <div class="form-group">
            <label for="pricecon">Precio de contado</label>
            <input type="number" class="form-control" name="pricecon" id="pricecon"  aria-describedby="helpId" disabled>
          </div>
    </div>
    <div class="form-group col-md-3">
        <div class="form-group">
            <label for="pricecred">Precio de crédito</label>
            <input type="number" class="form-control" name="pricecred" id="pricecred"  aria-describedby="helpId" disabled>
        </div>
    </div>
  </div>
