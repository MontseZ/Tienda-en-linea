        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card text-white bg-warning">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>PEN {{$total->totalcompra}} (DÍA ACTUAL)</strong>
                    </div>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card  text-white bg-info">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>PEN {{$total->totalventa}} (DIA ACTUAL) </strong>
                    </div>
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [<?php foreach ($comprasmes as $reg)
                            {echo ''. $reg->totalmes.',';} ?>],
                         backgroundColor: 'rgba(50,166,159,0.6)',
                        borderColor: 'rgba(50,166,159,0.6)',
                        borderWidth:3
                    }]
                },
                options: {
            ...
            var charVenta = new Chart(varVenta, {
                    ...
                    labels: [<?php foreach ($ventasmes as $reg)
                {
                    ...
                    datasets: [{
                        ...
                        {echo ''. $reg->totalmes.',';} ?>],
                        backgroundColor: 'rgba(50,61,255,0.5)',
            ...
            var charVenta = new Chart(varVenta, {
                    ...
                    labels: [<?php foreach ($ventasdia as $ventadia)
                {
                    ...
                    datasets: [{
                        ...
                        {echo ''. $reg->totaldia.',';} ?>],
                        backgroundColor: 'rgba(50,124,255,0.5)',
                        borderColor: 'rgba(54, 162, 235, 0.2)',
                        borderWidth: 1
                    }]
                },
