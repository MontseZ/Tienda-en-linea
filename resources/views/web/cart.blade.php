                    ...
                    {!! Form::open(['route'=>'shopping_cart.update', 'method'=>'PUT']) !!}
                        ...
                        <div class="cart-table table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="{{route('web.product_details', $shopping_cart_detail->product)}}"><img class="img-fluid" src="{{$shopping_cart_detail->product->images->pluck('url')[0]}}"
                                    alt="{{$shopping_cart_detail->product->name}}"/></a></td>
