                                ...
                                <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="{{$paymentPlatform->name}}payment">{{$paymentPlatform->name}} <img src="galio/assets/img/paypal-card.jpg" class="img-fluid paypal-card" alt="Paypal" /></label>
                                            </div>
                                        </div>
